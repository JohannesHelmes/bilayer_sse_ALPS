...
class necklace : public alps::scheduler::LatticeMCRun<graph_type>{

public:
    necklace(const alps::ProcessList& where,const alps::Parameters& p,int node);
...
typedef alps::scheduler::SimpleMCFactory<necklace> necklaceFactory;
#endif /* HBERG */
